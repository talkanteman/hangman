...
let CapLetterComponent = class CapLetterComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
let HangmanImgComponent = class HangmanImgComponent {
    constructor() { }
    ngOnInit() {
        this.imgSrc = [
...
let HangmanComponent = class HangmanComponent {
...
HangmanComponent.ctorParameters = () => [
...
let HangmanModule = class HangmanModule {
};
...
let BetLettersComponent = class BetLettersComponent {
    constructor() {
        this.guessedLetters = [];
...
let SingleLetterComponent = class SingleLetterComponent {
    constructor() { }
    ngOnInit() {
    }
};
